...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'gCHvG5E3vM3Pizm',
      'isDeleted':false,
      'username':'Allen_Feil',
      'email':'Carrie.Dibbert@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Allen_Feil' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'NAhjhvACSoqroUW',
      'isDeleted':false,
      'username':'Hortense.Auer89',
      'email':'Isabella_Simonis@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Hortense.Auer89' }, userToBeInserted,  { upsert: true });
