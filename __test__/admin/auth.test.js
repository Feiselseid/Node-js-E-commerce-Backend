...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Nils15',
      password: '9oQJBxGylGci2tF',
      email: 'Albert0@gmail.com',
      name: 'Ray Bechtelar',
      userType: 427,
      mobileNo: '(583) 806-6231',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 712,
      loginReactiveTime: '2023-09-18T19:31:27.456Z',
      ssoAuth: {
        googleId: 'Florida',
        facebookId: 'Timor-Leste' 
      },
      id: '634c0cdc0df450ce13266de3'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Arvid_Larson27',
        'password':'YSVtZ9WeWSnrhCp',
        'email':'Amina.Robel52@yahoo.com',
        'name':'Shannon Harber',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(785) 682-4801',
        'ssoAuth':{
          'googleId':'Fresh',
          'facebookId':'solution-oriented'
        },
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Amina.Robel52@yahoo.com', });
