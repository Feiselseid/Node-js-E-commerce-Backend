...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Caesar_Johnston26',
      password: 'tF79WOEqKex_aVg',
      email: 'Savanah14@hotmail.com',
      name: 'Richard Mante',
      userType: 596,
      mobileNo: '(487) 263-7720',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 482,
      loginReactiveTime: '2023-06-24T09:47:32.343Z',
      ssoAuth: {
        googleId: 'applications',
        facebookId: 'customer' 
      },
      id: '634c0cdc0df450ce13266e13'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Heaven_Kessler78',
        'password':'_YSzdb57XOZzvyg',
        'email':'Chasity.Macejkovic83@hotmail.com',
        'name':'Dr. Mae Vandervort',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(923) 962-7520',
        'ssoAuth':{
          'googleId':'algorithm',
          'facebookId':'Unbranded'
        },
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Chasity.Macejkovic83@hotmail.com', });
